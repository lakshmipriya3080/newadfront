...
const Login = () => {
    ...
    const [formErrors, setFormErrors] = useState({ hrid: '', password: '' });


   
  //   const [error,setError]=useState(false)
  //   var [inputs,setInputs] = useState({"hrid":'',"password":''})
  //   useEffect(()=>{
  //     axios.get( "http://localhost:4005/logins")
  //     .then(response =>{
    ...
    <ThemeProvider  theme={defaultTheme} >
      ...
      <h1 align='center'>ADMIN LOGIN</h1>
       <TextField  margin="normal" required fullWidth id="HR ID" label="HR ID" name="id" 
             ...
             {formErrors.hrid && <p style={{ color: 'red' }}>{formErrors.hrid}</p>}<br/>
